...
module.exports.run = async (_client, message, args, prefix) => {
  ...
  if(amount > bank) return message.channel.send('```Failture: You are not have soooo many diamonds```');
  ...
  .setDescription(`**You successfully topped up your money for ${amount}**${getEmoji('609830156604932103', _client)}`)
  ...
  console.log(`[${Date()}] ${prefix}unbank - User -- ${message.author.username}`)
}
